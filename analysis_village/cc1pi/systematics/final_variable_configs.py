...
class VariableConfig:
    ...
    def muon_momentum(cls):
        return cls(
            ...
            var_unit="[GeV/c]",
            bins= np.array([0.1, 0.25, 0.4,0.6, 0.85, 2]),
            var_evt_reco_col=('slc','measure_var', 'reco_p_mu', ''),
            var_evt_truth_col=('truth', 'true_var', 'true_p_mu', ''),
            var_nu_col=('truth', 'true_var', 'true_p_mu', ''),
