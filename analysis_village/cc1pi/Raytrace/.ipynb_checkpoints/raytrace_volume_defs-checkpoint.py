...
no_FV: list[dict] = [
    dict(x_range=(-200.0, 0.0), y_range=(-200.0, 200.0), z_range=(0.0, 500.0)),
    dict(x_range=(0.0, 200.0), y_range=(-200.0, 200.0), z_range=(0.0, 500.0)),
]
...
FV_SPLIT_TRUNCY_OFFICIAL_BOXES: list[dict] = [
    dict(x_range=(-190.0, -5.0), y_range=(-190.0, 190.0), z_range=(10.0, 250.0)),
    dict(x_range=(5.0, 190.0), y_range=(-190.0, 190.0), z_range=(10.0, 250.0)),
    dict(x_range=(-190.0, -5.0), y_range=(-190.0, 100.0), z_range=(250.0, 450.0)),
    dict(x_range=(5.0, 190.0), y_range=(-190.0, 190.0), z_range=(250.0, 450.0)),
]
...
RAYTRACE_VOLUME_DEFS: list[tuple[str, list[dict]]] = [
    ...
    ("FV_split_truncY_only_highx", FV_SPLIT_TRUNCY_OFFICIAL_BOXES),
...
RAYTRACE_VOLUME_LABEL: dict[str, str] = {
    ...
    "FV_split_truncY_only_highx": r"$5<|x|<190$: $|y|<190$ ($10<z<250$), x<0: $-190<y<100$ ($250<z<450$),  x>0: $-190<y<190$ ($250<z<450$)",
}
