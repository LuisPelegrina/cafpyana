...
vector<map<int, vector<double>>> PhysdEdx::pdg_plane_map = {
    //Plane 0 functions
    {
      {13, {0.107936,0.0244342,2.25823}},
      {2212, {-1,-1,-1}},
      {211, {0.127705,0.0260447,2.05065}}
    },
    //Plane 1 functions
    {
      {13, {0.08655,0.0609178,1.71898}},
      {2212, {-1,-1,-1}},
      {211, {0.0489597,0.0926731,1.32994}}
    },
    //Plane 2 functions
    {
      {13, {0.0863458,0.00526453,3.16196}},
      {2212, {-1,-1,-1}},
      {211, {0.0339961,0.014597,2.49474}}
    }
  };
